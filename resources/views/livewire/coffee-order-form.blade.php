<div class="flex bg-[#FFF8F0] flex-col h-screen items-center justify-center">
                ...
                <div class="flex flex-col md:flex-row gap-6 w-4xl h-full items-center">
                    ...
                    <div class="flex flex-col md:w-2/3 h-full justify-center bg-white rounded-xl p-4 md:p-8 border border-[#E6BF8D] ">
                        ...
                        <div class ="flex md:flex-row flex-col gap-4 justify-between items-center">
                                ...
                                <button wire:click="nextStep" id="create_account" class="w-full sm:w-auto order-first flex-1 md:order-last px-6 py-4 rounded-full bg-red-500 hover:bg-red-600 text-white font-semibold shadow text-base cursor-pointer">Create your account</button>                                
                        </div> 
                    </div>
    ...
    @if ($step === 3)
                <div class="flex flex-col md:flex-row gap-6 w-4xl h-full items-center">
                    ...
                    <div class="flex flex-col md:w-2/3 h-full justify-center bg-white rounded-xl p-4 md:p-8 border border-[#E6BF8D] ">
                        ...
                        <div class="w-full mb-4">                            
                            <input wire:model="country" type="text" class="w-full rounded-xl border {{ $errors->has('country') ? 'border-red-500' : 'border-gray-300' }} px-4 py-3 text-base" placeholder="City" />
    ...
    <!-- <script>
        Livewire.on('fb-event', function (eventName) {
            console.log('Livewire event received:', eventName);
            fbq('track', eventName);
        });
    </script> -->
...
<script>
    document.addEventListener('DOMContentLoaded', function () {
        console.log('📦 fb-event listener initialized');

        window.addEventListener('fb-event', function (event) {
